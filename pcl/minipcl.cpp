...
//void setUpSamplingMethod(pcl::MovingLeastSquares<pcl::PointXYZ, pcl::PointXYZ> &mls, int val) {
// mls.setUpsamplingMethod((pcl::MovingLeastSquares<pcl::PointXYZ, pcl::PointXYZ>::UpsamplingMethod)val);
//}
