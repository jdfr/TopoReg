...
setup(name='python-pcl',
      ...
      license='BSD',
      packages=["pcl"],
      #ext_modules=[Extension("pcl._pcl", ["pcl/_pcl.pyx", "pcl/minipcl.cpp", "pcl/adhoc.cpp"],
      #ext_modules=[Extension("pcl._pcl", ["pcl/_pcl.pyx", "pcl/minipcl.cpp", "pcl/cpd_impl.cpp"],
      #ext_modules=[Extension("pcl._pcl", ["pcl/_pcl.pyx", "pcl/minipcl.cpp"],
      ext_modules=[Extension("pcl._pcl", ["pcl/_pcl.pyx", "pcl/minipcl.cpp", "pcl/adhoc.cpp"],
                             #extra_objects=['pcl/cpd_impl.o'], 
                             language="c++", **ext_args),
                   Extension("pcl.registration", ["pcl/registration.pyx", "pcl/myndt.cpp"],
                             language="c++", **ext_args),
                  ],
